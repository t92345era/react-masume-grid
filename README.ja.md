...
![IME をオンにしたまま「A」を押すと、セルが編集状態になり「あ」がそのまま入る。変換確定の Enter ではセルは移動しない](https://raw.githubusercontent.com/t92345era/react-masume-grid/main/public/ime.gif)

*IME をオンにしたままセルで「A」を押すと、編集状態になって「あ」がそのまま入ります。変換を確定する Enter が
セル移動と誤解されることもありません。[デモ](https://t92345era.github.io/react-masume-grid/#/ja/guide/ime)を実際に操作して記録したものです。*
